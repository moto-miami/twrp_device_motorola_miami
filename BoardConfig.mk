...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 243724693504

# Assert
TARGET_OTA_ASSERT_DEVICE := miami, miami_retcn

# Dynamic Partition && Super
BOARD_SUPER_PARTITION_SIZE := 9529458688
BOARD_QTI_DYNAMIC_PARTITIONS_SIZE := 9525264384 # BOARD_SUPER_PARTITION_SIZE - 4MB
...
TW_LOAD_VENDOR_MODULES := "$(notdir $(wildcard $(DEVICE_PATH)/prebuilt/*.ko))"
